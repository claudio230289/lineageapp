...
// CORRECCIÓN CLAVE: Inicia selección de archivo SIN alertas/dialogos previos para no bloquear el toque
...
// CORRECCIÓN DÓLAR: Maneja comas y valida el valor adecuadamente
...
// COTIZACIÓN AUTOMÁTICA DESDE API ARGENTINA
...
async function initApp() {
    try {
        ...
        // Obtiene automáticamente el dólar de la API sin bloquear
